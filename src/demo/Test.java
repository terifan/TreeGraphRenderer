...
public class Test
{
	public static void main(String... args)
	{
		try
		{
			...
			frame.add(new TreeRenderer("'*:Jalapeno:Mango'['*:Dove'['Apple:Banana:Circus','Dove:Ear:Female'],'*:Japanese'['Gloves:Head:Internal','Japanese:Knife:Leap'],'*:Quality'['Mango:Nose:Open','Quality:Rupee']]").render(new HorizontalLayout()));
